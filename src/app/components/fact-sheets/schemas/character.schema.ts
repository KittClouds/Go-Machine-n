import { EntityFactSheetSchema } from '../types';

/**
 * Character Entity Schema
 * Defines the cards and fields for CHARACTER entities
 */
    ...
    cards: [
        {
            ...
            fields: [
                ...
                },
                {
                    ...
                    type: 'text',
                    placeholder: 'Click to add occupation...',
                },
                {
                    name: 'background',
                    label: 'Background',
                ...
                },
                {
                    ...
                    type: 'text',
                    multiline: true,
                    placeholder: 'Click to add personality...',
                },
                {
                    name: 'age',
                    label: 'Age',
                ...
                },
                {
                    ...
                    label: 'Species/Race',
                    type: 'text',
                    placeholder: 'Click to add species...',
                },
                {
                    name: 'gender',
                    label: 'Gender',
                    type: 'text',
                    placeholder: 'Click to add gender...',
                },
            ],
        },
        {
            ...
            fields: [
                {
                    ...
                    type: 'text',
                    multiline: true,
                    placeholder: 'Notes visible to all...',
                },
                {
                    name: 'privateNotes',
                    label: 'Private Notes',
                    type: 'text',
                    multiline: true,
                    placeholder: 'Hidden notes and secrets...',
                },
                {
                    name: 'goals',
                    label: 'Goals',
